...
const generatePdf = async (req, res) => {
  try {
    ...
    data.products.forEach((d, i) => {
      ...
      // New Calculation of product price
      let unit_cost = 1;
      if (!productsOfCalculation.includes(d.name)) {
      ...
      //   unit_cost = d.length;
      // } else if (!productsOfCalculation.includes(d.name)) {
...
*/
    ...
    const filepath = SERVER_URL + "/generate/docs/invoices/" + filename;
